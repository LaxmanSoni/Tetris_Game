...
background_img = pygame.image.load("D:/python/Tetris/background_img.jpg")      
instructions_img = pygame.image.load("D:\python\Tetris\instructions_img.jpg")  
icon_img = pygame.image.load("D:\python\Tetris\icon.png")
